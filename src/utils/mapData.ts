...
const option = {
  ...
  tooltip: {
    ...
    formatter: (content: any) => {
      if (content.seriesName === 'CA') {
        return `<div style="width: 300px">
            <img src="${content.data.img}">
            <p style="margin: 17px;">${content.name}</p>
            </div>`;
      }
    },
  },
      ...
      data: [
        {
          id: '2',
          name: '加利福尼亚州仓',
          value: [-117.5276107, 33.83196, null],
          img: '/front/加州洛杉矶佩里斯仓.jpg',
        },
        {
          id: '4',
          name: '田纳西州仓',
          value: [-89.8771823, 35.0370565, null],
          img: '/front/田纳西州孟菲斯仓.jpg',
        },
        {
          id: '5',
          name: '德克萨斯州仓',
          value: [-95.084587, 29.699558, null],
          img: '/front/德州拉波特仓.jpg',
        },
        {
          id: '8',
          name: '宾夕法尼亚州仓',
          value: [-76.5238368, 41.165631, null],
          img: '/front/宾夕法尼亚仓.jpg',
        },
        {
          id: '12',
          name: '乔治亚州仓',
          value: [-81.23158, 32.29157, null],
          img: '/front/乔治亚洲仓.jpg',
        },
      ],
      showEffectOn: 'render',
...
const mobileOption = {
  ...
  tooltip: {
    ...
    formatter: (content: any) => {
      if (content.seriesName === 'CA') {
        return `<div style="width: 5.04rem">
            <img style="width: 100%;" src="${content.data.img}">
            <p style="color: #333;font-size: 0.24rem;margin: 0.34rem;">${content.name}</p>
            </div>`;
      }
    },
  },
...
export { mapJson, option, mobileOption };
